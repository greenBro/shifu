...
public class DragImageView extends ImageView {
    ...
    public void setmActivity(Activity mActivity) {
        ...
        ScreenControl control = new ScreenControl(mActivity);
        int screenWide = control.getScreenWide();
        int screenHigh = control.getScreenHigh();
        MAX_W = (int) (screenWide * 1.5);
        MAX_H = (int) (screenHigh * 1.5);
        MIN_W = (int) (screenWide * 0.2);
        MIN_H = (int) (screenHigh * 0.2);
        screen_W = screenWide;
        screen_H = screenHigh;
    }
    ...
    public void setImageBitmap(Bitmap bm) {
        ...
        System.out.println("bitmap_W" + bitmap_W + "bitmap_H" + bitmap_H);
        MAX_W = bitmap_W * 3;
        MAX_H = bitmap_H * 3;
